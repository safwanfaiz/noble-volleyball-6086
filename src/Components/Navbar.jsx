            ...
            <div id={styles.mainMenu1}>
              <div className={styles.dropDown}>
                <ul>
                  ...
                  <li>
                    <NavLink
                      to="/https://www.bewakoof.com/men-printed-tshirts"
                      onClick={() => setActive("")}
                    >
                      Printed T-Shirt
                    </NavLink>
                ...
                <ul>
                  ...
                  <li>
                    <NavLink to="/products/men-joggers">Breifs</NavLink>
                  </li>
                </ul>
                <ul>
                  <li>
                ...
                <ul className={styles.typesofMenu}>
                  <li>
                    <NavLink to="/products/men-activewear">
                      <img
                        src="https://images.bewakoof.com/nav_menu/icon-168-1668158001.png"
                        alt=""
                      />
                      <span>Streat Wear Collection</span>
                    </NavLink>
                  </li>
                  ...
                  <li>
                    <NavLink to="/products/men-activewear">
                      <img
                        src="https://images.bewakoof.com/nav_menu/icon-winter-1665155950.png"
                        alt=""
                      />
                      <span>Winter Wear Collection</span>
                    </NavLink>
                  </li>
                  <li>
                    <NavLink to="/products/men-activewear">
                      <img
                        src="https://images.bewakoof.com/nav_menu/Circle-icon-space-collection-1666891198.png"
                        alt=""
                      />
                  ...
                  <li>
                    <NavLink to="/products/men-activewear">
                      <img
                        src="https://images.bewakoof.com/nav_menu/Circle-Icon-1664893858.png"
                        alt=""
                      />
                      <span>Pokeymon Collection</span>
                    </NavLink>
                  </li>
                  <li>
                    <NavLink to="/products/men-activewear">
                      <img
                        src="https://images.bewakoof.com/nav_menu/Circle-icon-color-splash-1663442159.png"
                        alt=""
                      />
                      <span>Color Splash Collection</span>
                    </NavLink>
                  </li>
                  <li>
                    <NavLink to="/products/men-activewear">
